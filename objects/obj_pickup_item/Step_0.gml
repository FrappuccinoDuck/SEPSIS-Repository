...
if type == "Item" && obj_item_manager.debug_menu == false && global.hold_pickup == false
{
	//--------------------------------------
...
{
	if keyboard_check_pressed(obj_game_initializers.left_hand_hold) && global.left_hand_item != noone && obj_item_manager.stats_open == false && global.left_hand_item != global.item_list.two_hand_item && global.left_hand_item != global.hover_item && !keyboard_check_direct(vk_control)
	{
	...
	} if keyboard_check_pressed(obj_game_initializers.right_hand_hold) && global.right_hand_item != noone && obj_item_manager.stats_open == false && global.right_hand_item != global.item_list.two_hand_item && global.right_hand_item != global.hover_item && !keyboard_check_direct(vk_control)
	{
