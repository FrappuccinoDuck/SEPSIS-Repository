...
if obj_item_manager.stats_open == false && obj_player.dead == false && global.settings_open == false && obj_health_manager.health_open == false && obj_item_manager.player_stats == false
{
	var S_smooth
